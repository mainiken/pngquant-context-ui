...
Компактное UI-расширение для классического контекстного меню Windows 11. Оно сжимает PNG-файлы через `pngquant` без необходимости открывать полноценное приложение Pngyu.

Проект не является отдельным PNG-компрессором. Это небольшая shell/UI-оболочка для `pngquant`: сначала установите `pngquant.exe`, положите его рядом с приложением или разрешите приложению скачать официальный Windows-бинарник при первом запуске.
